...
public class StudentDashboard extends JFrame {
    ...
    private void initUI() {
        ...
        // Row 1: Attempt Quiz and View Results
        cardGbc.gridx = 0;
        cardGbc.gridy = 0;
        cardsContainer.add(createActionCard(
            ...
            e -> SwingUtilities.invokeLater(() -> new AttemptQuizPage(this).setVisible(true))
        ), cardGbc);
        ...
        // Row 2: My Profile and Change Password
        cardGbc.gridx = 0;
        cardGbc.gridy = 1;
        cardsContainer.add(createActionCard(
            "My Profile",
    ...
    private JPanel createHeader() {
        ...
        JLabel subtitle = new JLabel("Access your quizzes and results");
